...
//    Shader lampShader("/书/OGL_Test/lampVS.txt", "/书/OGL_Test/lampFS.txt");
    ...
    Shader depthShader("/书/OGL_Test/depth_testingVS.txt", "/书/OGL_Test/depth_testingFS.txt");
...
//    unsigned int specularMap = loadTexture("/书/OGL_Test/container2_specular.jpg");
    unsigned int cubeTexture  = loadTexture("/书/OGL_Test/im.png");
    unsigned int floorTexture = loadTexture("/书/OGL_Test/container.jpg");
