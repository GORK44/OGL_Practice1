...
//加载纹理贴图
unsigned int GORK::LoadTexture(char const * pathFolder, char const * fileName, char const * suffix, bool isFlipped, bool isRepeated, bool gammaCorrection) //pathFolder文件夹路径，fileName文件名，suffix后缀
{
    char path[100];
