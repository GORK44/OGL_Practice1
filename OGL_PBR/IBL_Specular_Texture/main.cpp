...
//    Shader pbrShader("/书/OGL_Test/Shader/pbr_redBall.vs", "/书/OGL_Test/Shader/pbr_redBall_specularIBL.fs");
    Shader pbrShader("/书/OGL_Test/Shader/pbr_redBall.vs", "/书/OGL_Test/Shader/pbr_IBL.fs");
...
//    char folderName[] ="/书/OGL_Test/材质/metalgrid2-ogl";
    ...
    unsigned int albedoMap    = loadTexture(folderName, "/basecolor.png",Flip,Repeat,RGB);
    unsigned int normalMap    = loadTexture(folderName, "/normal.png",Flip,Repeat,RGB);
    unsigned int metallicMap  = loadTexture(folderName, "/metallic.png",Flip,Repeat,RGB);
    unsigned int roughnessMap = loadTexture(folderName, "/roughness.png",Flip,Repeat,RGB);
    unsigned int aoMap        = loadTexture(folderName, "/ao.png",Flip,Repeat,RGB);
